...
For logical, since we divide out input into two categories, greater than or smaller than 0, so for input that greater than 0 has output TRUE counts are 1, and for input that smaller than 0 has output FALSE counts as 0.
